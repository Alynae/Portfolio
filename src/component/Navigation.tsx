...
const Navigation = () => {
  ...
  return (
    <Navbar bg="light" expand="lg" fixed="top" >
      <Navbar.Brand as={NavLink} exact to="/portfolio/about" style={{marginLeft:"7%"}}>Jérémy Le bricquer</Navbar.Brand>
      <Navbar.Toggle />
      <Navbar.Collapse className="justify-content-end">
        <Nav >
          <Nav.Link  as={NavLink} className="itemLink" exact to="/portfolio/about" >Home</Nav.Link>
